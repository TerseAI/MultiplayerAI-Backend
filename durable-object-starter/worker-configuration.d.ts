/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1368c83917a91593209e519f6bb4c235)
// Runtime types generated with workerd@1.20260828.1 2026-08-25 
interface __BaseEnv_Env {
	TERSE_INTERNAL_SECRET: string;
	OPEN_ROUTER_API_KEY: string;
	COMPOSIO_API_KEY: string;
	COMPOSIO_DEMO_SESSION_ID: string;
	AGENTS: DurableObjectNamespace<import("./src/index").AgentDurableObject>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TERSE_INTERNAL_SECRET" | "OPEN_ROUTER_API_KEY" | "COMPOSIO_API_KEY" | "COMPOSIO_DEMO_SESSION_ID">> {}
}
